...
그 이유는 SaaS 데이터에서 결측은 종종 “정보가 없음”이 아니라 **“그 행동이 일어나지 않았음” 또는 “그 정보가 수집되지 않았음” 자체가 신호**가 될 수 있기 때문이다.
...
![threshold change](assets/images/threshold_change.png)
![recommendation](assets/images/recommendation.png)
